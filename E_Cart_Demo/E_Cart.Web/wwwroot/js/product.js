        ...
        columns: [
            ...
            { data: 'stock',className: 'td-number', visible: isAdmin.toString() == "1" ? true : false },
            {
                data: null, className:'td-actions td-right', sorting:false, render: function (data, type, row) {
                    var button = isAdmin.toString() == "1" ? '<button type="button" rel="tooltip" class="btn btn-success btn-just-icon btn-sm edit-product"><i class="ri-edit-2-line"></i></button> | <button type="button" rel="tooltip" class="btn btn-danger btn-just-icon btn-sm delete-product"><i class="ri-delete-bin-2-line"></i></button>' : '<button class="btn btn-primary btn-just-icon btn-sm add-to-cart"><i class="ri-shopping-cart-2-line"></i></button>';
                    return button;
                }
            }
        ]
